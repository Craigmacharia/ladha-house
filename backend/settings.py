...
REACT_APP_BUILD_DIR = os.path.join(BASE_DIR, 'ladhahouse-frontend', 'dist')  # or 'build' if using CRA
...
SECRET_KEY = 'django-insecure-93kf&vu*k%@&%#bq2ag2ivhz2cjylx8)a488lf4g86o=bi5w@e'
...
TEMPLATES = [
    {
        ...
        'DIRS': [REACT_APP_BUILD_DIR],  # <-- This line is new
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
